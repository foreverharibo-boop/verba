...
- SCENE-FIRST RECOMPOSITION: source text is scene evidence, not a wording template. Within each editable id, understand the facts and speech intent, then author that scene directly in Korean. No word-by-word, clause-by-clause or sentence-by-sentence correspondence is required. Replace vocabulary, restructure clauses, split/merge sentences and redistribute description around Korean information flow; preserve event order, causality, protected layout and narration/dialogue boundaries. Never move facts between ids or import context into a selected excerpt.
- Preserve the full scene, not each descriptive phrase: retain sensory facts, atmosphere, interiority, emotional progression, viewpoint, tense and uncertainty in the passage as a whole. Their wording, location and rhetorical packaging are free. Do not summarize away information or invent a new action to illustrate an emotion.
- Let sentence length follow the scene: join continuous action, separate a realization when it lands, and re-anchor the actor naturally. Do not copy the English sentence skeleton and merely swap synonyms, add adjectives or increase slang/profanity. Korean naturalness outranks surface resemblance whenever scene truth is unchanged.
...
SUPREME COMMAND: FACTS LOCKED; EXPRESSION FULLY RECOMPOSED
...
2. SOURCE IS SCENE EVIDENCE, NOT A WORDING TEMPLATE: abandon lexical and sentence correspondence. Every word, clause shape, sentence boundary, rhetorical device and figurative vehicle may be replaced. Preserve what happened and what the speakers mean; write how a Korean author would have conceived this scene without the English wording.
3. Natural Korean scene composition takes priority over resemblance to source expression. Follow KOREAN-ORIGINAL COMPOSITION below within each supplied id; no fact may be lost, invented or moved outside that id.
...
5. Never add, remove, reverse, transfer or make more specific a scene fact, action, intention, reaction, object, event or setting detail. Keep emotional direction, force and consent; the separately authorized voice settings govern surface diction only. Expressions and figurative vehicles are not facts unless their literal identity matters to the scene.
...
- Understand the complete scene and recurring referents; compose final Korean directly from its facts and speech acts, not from an intermediate literal translation. Check factual completeness and natural Korean before returning. No separate draft, explanation or extra response.
...
- SCENE-FIRST RECOMPOSITION: source is scene evidence, not a wording template. Author final Korean directly in one pass. Discard word/clause/sentence correspondence; replace all vocabulary, syntax, rhetorical packaging and sentence rhythm as needed. Never answer, continue, summarize or explain.
...
- Rebuild dialogue from its speech act/subtext and actual speaker/listener/register. Replace idiom/joke/metaphor vehicles or express their meaning directly; preserve purpose/effect and any actual object/action or plot-relevant wording. Replacement is not a new decorative metaphor. Keep technical terms when factual information is the point. Add no event, motive, accusation or new joke; voice settings alone authorize surface slang/profanity. Never infer old/dialect speech from age/job/genre; avoid unsupported 드쇼/하쇼/구먼/일세/-인가/-하게/-라네. Use coherent Korean subjects, modifiers and predicates.
- References: TARGET CHARACTER=${JSON.stringify(characterName)}; TARGET gender=${JSON.stringify(String(speakerIdentity.characterGender || 'unknown'))}; USER=${JSON.stringify(userName)}. Transliterate clear Latin-script human names into Hangul, excluding non-person terms; explicit name locks override transliteration. Never expand a short source name or repeat display names mechanically. 그/그녀/그의/그녀의 are allowed. Omit a subject/possessive only when omission itself is clearly more natural in an immediately linked sentence; re-anchor with name/pronoun after actor changes or intervening description. Never rotate a known person through 여자/남자/녀석/상대/사람/사내/청년/작은 몸, guess an identity, split a name, or output particle-choice notation such as (이)는/이(가)/은(는).
...
- Author the same scene directly in Korean from facts and speech acts. Facts are fixed; all verbal expression is free under SCENE-FIRST RECOMPOSITION below. Produce one final response, without a literal draft or added explanation.
