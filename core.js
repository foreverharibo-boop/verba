...
- NATURAL COLLOCATIONS AND SOURCE IMAGERY: preserve meaningful source metaphors and their effect in idiomatic Korean, but do not invent a metaphor for an ordinary expression, action, or emotion. Before returning, check subject–predicate, verb–object, and modifier–noun combinations; replace an unnatural combination with a direct rendering of the same meaning. Keep the actual experiencer and physical action clear. Do not add imagery, emotion, or intensity merely to sound literary. Preserve natural source-supported description; this is not a ban on figurative prose. Subject/possessive omission follows PRIMARY CAST REFERENCES, not a blanket translationese rule.
...
- SOURCE ELLIPSIS FIDELITY: keep each source hesitation/trailing-dot sequence exactly, including the dot count and character form: "..." stays "...", "…" stays "…", and "……" stays "……". Do not lengthen, shorten, normalize, omit, duplicate, or invent an ellipsis to dramatize the Korean. Place each at its corresponding pause in the translated passage; for selected fragments, preserve only pauses belonging to that fragment, never import surrounding ones. This also applies with the optional voice add-on enabled. It does not require matching the total number of sentence-ending periods after sentence restructuring; do not modify decimals, URLs, code, or protected tokens.
