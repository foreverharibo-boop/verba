...
export function createPromptBuilders(h) {
    ...
    function galbwae(s = {}, scope = 'mixed') {
        ...
        return lines([
            ...
            '- STYLE EXAMPLES (pattern examples, not text to copy): "나 알아?" → "나를 아늕랴!!"; "어떻게 해야 해요?" → "어덕헤 해야대요??"; "계속 보고 있었어요." → "개속 보고잇엇내요"; "도와주세요." → "도아주새요 ㅠㅠ"; "정말 무서웠어요." → "진자 너무무서웟어요;;"; "왜 그러는 거야?" → "왜그러는건대요????"',
            `- CURRENT SCOPE=${scope}.`,
        ]);
    }
