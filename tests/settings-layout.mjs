...
const render=Function('dev','escapeHtml',defs+`
    ...
    const EXTENSION_VERSION='0.5.84',lastQualityAuditSummary='',lastDebugDiagnostic=null;
...
`+between('function tuningChoiceMarkup(', 'function normalizeTranslationRuleOrder(')
 ...
 +between('function customTranslatorSimpleTemplate(', 'function injectSettingsPanel(')
...
assert.equal(manifest.version,'0.5.84');assert.ok(index.includes("const EXTENSION_VERSION = '"+manifest.version+"';"));
