...
const render=Function('dev','escapeHtml',defs+`
    ...
    const EXTENSION_VERSION='0.5.82',lastQualityAuditSummary='',lastDebugDiagnostic=null;
...
`+between('function tuningChoiceMarkup(', 'function normalizeTranslationRuleOrder(')
 ...
 +between('function customTranslatorSettingsMarkup(', 'function injectSettingsPanel(')
...
assert.equal(manifest.version,'0.5.82');assert.ok(index.includes("const EXTENSION_VERSION = '"+manifest.version+"';"));
