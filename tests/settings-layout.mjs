...
const render=Function('dev','escapeHtml',defs+`
    ...
    const EXTENSION_VERSION='0.5.72',lastQualityAuditSummary='',lastDebugDiagnostic=null;
...
assert.equal(manifest.version,'0.5.72');assert.ok(index.includes("const EXTENSION_VERSION = '"+manifest.version+"';"));
