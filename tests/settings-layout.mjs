...
const render=Function('dev','escapeHtml',defs+`
    ...
    const EXTENSION_VERSION='0.6.6',lastQualityAuditSummary='',lastDebugDiagnostic=null;
...
assert.equal(manifest.version,'0.6.6');assert.ok(index.includes("const EXTENSION_VERSION = '"+manifest.version+"';"));
