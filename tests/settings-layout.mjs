...
const render=Function('dev','escapeHtml',defs+`
    ...
    const EXTENSION_VERSION='0.6.4',lastQualityAuditSummary='',lastDebugDiagnostic=null;
    ...
    const normalizedProfileRaceTimeoutMinutes=()=>5,normalizedProfileFailureTimeoutSeconds=()=>120,normalizedProfileFailureTimeoutMinutes=()=>2;
...
assert.equal(manifest.version,'0.6.4');assert.ok(index.includes("const EXTENSION_VERSION = '"+manifest.version+"';"));
